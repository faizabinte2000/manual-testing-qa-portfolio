...
| TC-014 | Checkout | Verify checkout order summary | Valid product is in the cart and checkout information is completed | Proceed to Checkout: Overview | Order summary should display the correct product, quantity, price, item total, tax, and final total | Sauce Labs Backpack was displayed with quantity 1 and price $29.99. Item total was $29.99, tax was $2.40, and final total was $32.39. Payment and shipping information were also displayed. | Pass |
| TC-015 | Checkout | Complete an order successfully | Valid product is in cart and checkout information is completed | Click "Finish" on the Checkout: Overview page | Order should be completed and a confirmation message should be displayed | Checkout was successfully completed. The "Checkout: Complete!" page and "Thank you for your order!" confirmation message were displayed. | Pass |
| TC-016 | Products | Verify product sorting by Price (Low to High) | User is logged in and Products page is displayed | Select "Price (low to high)" from the sorting dropdown | Products should be displayed in ascending order of price | Products were successfully reordered from lowest to highest price. | Pass |
